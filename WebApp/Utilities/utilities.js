...
class GridIcon extends GridCard {
    ...
    static get styleSheet(){
        return new URL('assets/grid-icon-CPOYaWst.css', import.meta.url).href;
    }
}
...
class GridLayout extends SvgPlus {
     ...
     * The items can be provided as a 2D array, where each sub-array represents a row of items.
     * @param { SvgPlusClass } classDef - The class definition to use for creating the items (e.g., GridIcon).
